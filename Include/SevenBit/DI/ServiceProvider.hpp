...
namespace sb::di
{
    class ServiceProvider
    {
      ...
      public:
        ...
        /**
         * @brief Return service pointer might be null
        ...
        /**
         * @brief Return service reference might throw exception
         ...
         * @details If the service was not registered or was registered as transient, method returns empty vector
         *
         * Example:
         * @code{.cpp}
         ...
         * @details If the service was not registered or was registered as scoped/singleton, method returns null
         *
         * Example:
         * @code{.cpp}
         ...
         * @details If the service was not registered or was registered as scoped/singleton, method returns empty vector
         *
         * Example:
         * @code{.cpp}
         * auto provider = ServiceCollection{}
